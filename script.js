document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        ...
        es: {
            ...
            hero_bio: "Investigador de doctorado enfocado en la optimización de Machine Learning y Computación de Alto Rendimiento. Especializado en desarrollar soluciones eficientes de modelos de Machine Learning en arquitecturas RISC-V y algoritmos paralelos. Apasionado por cerrar la brecha entre la investigación de vanguardia y los sistemas del mundo real para construir productos funcionales, escalables y de alto rendimiento.",
            section_research: "Mis proyectos de investigación",
